import { a as Collection, o as CollectionEventType_default, t as VectorSource } from "./Vector-D1Sdo3Rg.js";
import { D as ObjectEventType_default, E as EventType_default$1, T as Disposable, a as getUid, b as equals, d as BaseEvent, f as FALSE, g as toPromise, i as abstract, l as unlistenByKey, m as VOID, n as BaseObject, o as Observable, p as TRUE, r as VERSION, s as listen, t as assert, u as Target } from "./asserts-Dv-Z02ND.js";
import { f as toRadians, l as squaredSegmentDistance, m as clear, n as clamp } from "./math-DFmbvhZD.js";
import { o as Feature } from "./Feature-B6dWdY85.js";
import { C as getUserProjection, D as toUserCoordinate, Ft as wrapX, G as wrapX$1, Ot as getWidth, Q as approximatelyEquals, S as getTransformFromProjections, St as getForViewAndSize, U as rotate, V as degreesToStringHDMS, W as scale, Y as warn, Z as applyTransform, bt as getCenter, ft as equals$1, g as fromUserCoordinate, it as containsExtent, jt as isEmpty, kt as intersects, lt as createOrUpdateEmpty, m as equivalent, rt as containsCoordinate, tt as clone, w as identityTransform, wt as getIntersection, x as getTransform, y as get } from "./proj-D8Kp6DbM.js";
import { C as compose, D as makeInverse, E as fromString, O as multiply, S as apply, w as create } from "./orient-5NaS0HD1.js";
import { l as Point, n as circular, t as Polygon } from "./Polygon-Db9x51DP.js";
import { t as LineString } from "./LineString-DU6I9wA1.js";
import { a as disable, c as linear, d as RenderEvent, i as View, m as EventType_default$2, n as inView, p as ViewHint_default, r as BaseLayer, s as easeOut, t as Layer } from "./Layer-BkddCmq2.js";
import { A as WEBKIT, C as removeChildren, D as DEVICE_PIXEL_RATIO, O as MAC, T as replaceNode, _ as createMockDiv, b as outerHeight, i as ImageWrapper, j as WORKER_OFFSCREEN_CANVAS, k as PASSIVE_EVENT_LISTENERS, t as hasArea, w as replaceChildren, x as outerWidth, y as isCanvas } from "./size-B6kgWAmt.js";
import { D as CLASS_HIDDEN, E as CLASS_CONTROL, M as shared, O as CLASS_SELECTABLE, T as CLASS_COLLAPSED, d as checkedFonts, k as CLASS_UNSELECTABLE, l as Stroke, n as Text, r as Style, u as Fill } from "./Icon-a_uAYoGy.js";
import { i as CanvasImmediateRenderer, n as BaseVectorLayer, r as getSquaredTolerance, t as VectorLayer } from "./Vector-B8fMGMXd.js";
import { a as ImageCanvas, i as getTilePriority, n as VectorRenderTile, r as TileQueue, t as VectorTile } from "./VectorTile-CmhGjquc.js";
import { i as Tile, r as ImageTile, t as TileRange } from "./TileRange-C9A9jBEr.js";
...
var Graticule = class extends VectorLayer {
	...
	*/
	loaderFunction(extent, resolution, projection) {
		...
		if (this.renderedExtent_ && equals$1(this.renderedExtent_, renderExtent) && this.renderedResolution_ === resolution) return;
