import { F as get, I as Projection, P as get$1, a as addProjection, d as createSafeCoordinateTransform, n as addCoordinateTransforms, r as addEquivalentProjections } from "./proj-D8Kp6DbM.js";
...
var projLookup = async function(code) {
	...
	const response = await fetch(`https://spatialreference.org/ref/${authority}/${num}/ogcwkt/`);
...
async function fromProjectionCode(code) {
	...
	if (proj4.defs(code)) return get(code);
...
async function fromEPSGCode(code) {
	if (typeof code === "number") code = "EPSG:" + code;
...
//#endregion
export { epsgLookupMapTiler, fromEPSGCode, fromProjectionCode, getEPSGLookup, getProjectionCodeLookup, isRegistered, register, setEPSGLookup, setProjectionCodeLookup, unregister };
